...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default=os.path.join(DIR, 'dataset','bridge-alloc'), help="data directory")
    ...
    parser.add_argument('--model_name', type=str, default='up2_ESPCN_epoch_50_Oct30_18.pth', help='model name')
    parser.add_argument('--ground_truth', type=lambda x: (str(x).lower() == 'true'), default=True, help='have ground truth or not')
    parser.add_argument('--test_dir', type=str, default=os.path.join(DIR, 'dataset','bridge-alloc','images','test'), help="testing data directory")
...
#    result = main(args)
    ...
    # tensor, len = 600, for each : (input, target) 
    val_set = get_val_set(args.band_mode, args.data_dir, args.aug, args.aug_mode, args.crop_size, args.upscale_factor)
    eval_set = get_eval_set(args.band_mode, args.data_dir, args.aug, args.aug_mode, args.crop_size, args.upscale_factor)
