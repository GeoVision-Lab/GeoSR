...
from archs.srdensenet import SRDenseNet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--base_kernel', type=int, default=16, help="base kernel")
...
#    result = main(args)
    ...
    if args.train:
        ...
        print('===> Building model')
        model = SRDenseNet(nb_channel=args.nb_channel, upscale_factor=args.upscale_factor, base_kernel=args.base_kernel).to(device)
        #criterion = nn.MSELoss()
        model.optimizer = optim.Adam(model.parameters(), lr=args.lr)
